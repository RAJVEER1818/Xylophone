...
private let log = Logger(subsystem: "co.appbrewery.xylophone.RunnerTests", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<RunnerTestsMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try RunnerTestsAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? RunnerTestsAudioUnit else {
            log.error("Unable to create RunnerTestsAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(RunnerTestsParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = RunnerTestsMainView(parameterTree: observableParameterTree)
